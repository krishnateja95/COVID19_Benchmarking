...
class RegNet_y_3_2gf(nn.Module):
    def __init__(self, num_classes = 3, stem_width = 32, stem_type = None, block_type = None,
        ...
        block_params = BlockParams.from_init_params(depth=21, w_0=80, w_a=42.63, w_m=2.66, group_width=24, se_ratio=0.25)
