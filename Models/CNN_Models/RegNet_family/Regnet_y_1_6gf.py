...
class RegNet_y_1_6gf(nn.Module):
    def __init__(self, num_classes = 3, stem_width = 32, stem_type = None, block_type = None,
        ...
        block_params = BlockParams.from_init_params(depth=27, w_0=48, w_a=20.71, w_m=2.65, group_width=24, se_ratio=0.25)
