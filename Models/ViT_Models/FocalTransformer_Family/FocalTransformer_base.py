...
class FocalTransformer_Base(nn.Module):
    def __init__(self, img_size=224, patch_size=4, in_chans=3, num_classes=3, embed_dim=128, depths=[2,2,18,2], num_heads=[4,8,16,32],
