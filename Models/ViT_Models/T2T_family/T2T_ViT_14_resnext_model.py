...
class T2T_ViT_14_resnext(nn.Module):
    def __init__(self, img_size=224, tokens_type='performer', in_chans=3, num_classes=3, embed_dim=384, depth=14,
                 num_heads=32, mlp_ratio=3., qkv_bias=False, qk_scale=None, drop_rate=0., attn_drop_rate=0.,
