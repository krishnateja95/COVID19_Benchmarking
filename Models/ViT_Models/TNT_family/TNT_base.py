...
class TNT_Base(nn.Module):
    def __init__(self, img_size=224, patch_size=16, in_chans=3, num_classes=3, global_pool='token', embed_dim=640,
                 inner_dim=40, depth=12, num_heads_inner=4, num_heads_outer=10, mlp_ratio=4., qkv_bias=False,
