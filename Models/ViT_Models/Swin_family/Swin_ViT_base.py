...
class Swin_ViT_Base(nn.Module):
    def __init__(self, img_size=224, patch_size=4, in_chans=3, num_classes=3,
                 embed_dim=96, depths=[2, 2, 30, 2], num_heads=[3, 6, 12, 24],
                 window_size=[7, 7, 14, 7], mlp_ratio=4., qkv_bias=True, qk_scale=None,
