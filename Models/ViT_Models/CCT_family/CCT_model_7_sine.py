...
class CCT_7_sine(nn.Module):
    def __init__(self, img_size=224, embedding_dim=256, n_input_channels=3, n_conv_layers=2, kernel_size=7,
                 pooling_kernel_size=3, pooling_stride=2, pooling_padding=1, dropout=0., attention_dropout=0.1,
                 stochastic_depth=0.1, num_layers=7, num_heads=4, mlp_ratio=2, num_classes=3, positional_embedding='sine'):
        super(CCT_7_sine, self).__init__()
