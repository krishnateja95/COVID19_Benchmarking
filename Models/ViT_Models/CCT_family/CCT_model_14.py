...
class CCT_14(nn.Module):
    def __init__(self, img_size=224, embedding_dim=384, n_input_channels=3, n_conv_layers=2, kernel_size=7,
                 ...
                 stochastic_depth=0.1, num_layers=14, num_heads=6, mlp_ratio=3, num_classes=3, positional_embedding='learnable'):
        super(CCT_14, self).__init__()
