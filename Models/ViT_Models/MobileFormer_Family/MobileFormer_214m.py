...
class MobileFormer_214M(nn.Module):
    def __init__(self, block_args= dna_blocks, num_classes=3, img_size=224, width_mult=1.0, in_chans=3, stem_chs=12, num_features=1600,dw_conv='dw',
        ...
        super(MobileFormer_214M, self).__init__()
