...
class MobileFormer_96M(nn.Module):
    def __init__(self, block_args= dna_blocks, num_classes=3, img_size=224, width_mult=1.0, in_chans=3, stem_chs=12, num_features=1280,dw_conv='dw',
        kernel_size=(3,3), cnn_exp=(6,4), group_num=1, se_flag=[2,0,2,0], hyper_token_id=0,hyper_reduction_ratio=4, token_dim=128,
        token_num=4, cls_token_num=1, last_act='relu', last_exp=6, gbr_type='attn', gbr_dynamic=[True, False, False], gbr_norm='post',
        ...
        super(MobileFormer_96M, self).__init__()
