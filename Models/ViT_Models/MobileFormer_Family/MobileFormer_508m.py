...
class MobileFormer_508M(nn.Module):
    def __init__(self, block_args= dna_blocks, num_classes=3, img_size=224, width_mult=1.0, in_chans=3, stem_chs=24, num_features=1920,dw_conv='dw',
        ...
        super(MobileFormer_508M, self).__init__()
