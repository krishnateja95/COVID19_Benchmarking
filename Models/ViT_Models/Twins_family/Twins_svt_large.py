...
class Twins_SVT_Large(nn.Module):
    def __init__(self, img_size=224, patch_size=4, in_chans=3, num_classes=3, global_pool='avg', embed_dims=[128, 256, 512, 1024],
                 num_heads=[4, 8, 16, 32], mlp_ratios=(4, 4, 4, 4), depths=[2, 2, 18, 2], sr_ratios=[8, 4, 2, 1],
