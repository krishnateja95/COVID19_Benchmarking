...
class Twins_SVT_Base(nn.Module):
    def __init__(self, img_size=224, patch_size=4, in_chans=3, num_classes=3, global_pool='avg', embed_dims=[96, 192, 384, 768],
                 num_heads=[3, 6, 12, 24], mlp_ratios=[4, 4, 4, 4], depths=[2, 2, 18, 2], sr_ratios=[8, 4, 2, 1],
                 wss=[7, 7, 7, 7], drop_rate=0., pos_drop_rate=0., proj_drop_rate=0., attn_drop_rate=0.,
