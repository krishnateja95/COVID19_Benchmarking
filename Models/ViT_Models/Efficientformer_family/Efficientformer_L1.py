...
class EfficientFormer_L1(nn.Module):
    def __init__(self, layers = [3, 2, 6, 4], embed_dims=[48, 96, 224, 448],  mlp_ratios=4, downsamples=[True, True, True, True], 
                 ...
                 fork_feat=False, init_cfg=None, pretrained=None, vit_num=1, distillation=False):
        super().__init__()
