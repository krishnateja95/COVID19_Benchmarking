...
class GCViT_Tiny2(nn.Module):
    def __init__(self, dim = 64, depths=[3, 4, 29, 5], window_size = [7, 7, 14, 7], mlp_ratio = 3, num_heads = [2, 4, 8, 16], 
                 resolution=224, drop_path_rate=0.25, in_chans=3,  num_classes=3, qkv_bias=True, qk_scale=None, 
