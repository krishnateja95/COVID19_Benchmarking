...
class GCViT_Small(nn.Module):
    def __init__(self, dim = 96, depths=[3, 4, 19, 5], window_size = [7, 7, 14, 7], mlp_ratio = 2, num_heads = [3, 6, 12, 24], 
                 resolution=224, drop_path_rate=0.3, in_chans=3,  num_classes=3, qkv_bias=True, qk_scale=None, 
