...
class ViT_Small_patch32(nn.Module):
    def __init__(self, img_size: Union[int, Tuple[int, int]] = 224, patch_size: Union[int, Tuple[int, int]] = 32, in_chans: int = 3,
            num_classes: int = 3, global_pool: str = 'token', embed_dim: int = 384, depth: int = 12, num_heads: int = 6, mlp_ratio: float = 4.,
