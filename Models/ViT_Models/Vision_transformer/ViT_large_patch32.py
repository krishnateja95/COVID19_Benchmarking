...
class ViT_Large_patch32(nn.Module):
    def __init__(self, img_size: Union[int, Tuple[int, int]] = 224, patch_size: Union[int, Tuple[int, int]] = 32, in_chans: int = 3,
            num_classes: int = 3, global_pool: str = 'token', embed_dim: int = 1024, depth: int = 24, num_heads: int = 16, mlp_ratio: float = 4.,
