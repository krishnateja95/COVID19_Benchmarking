...
class RegionViT_Tiny(nn.Module):
    def __init__(self, img_size=224, patch_size=4, in_chans=3, num_classes=3, embed_dim=[64, 64, 128, 256, 512], depth=[2, 2, 8, 2],
