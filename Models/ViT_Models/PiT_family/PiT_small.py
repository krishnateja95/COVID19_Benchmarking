...
class PiT_Small(nn.Module):
    def __init__(self, image_size=224, patch_size=16, stride=8, base_dims=[48, 48, 48], depth=[2, 6, 4], heads=[3, 6, 12],
                 mlp_ratio=4, num_classes=3, in_chans=3,
                 attn_drop_rate=.0, drop_rate=.0, drop_path_rate=.0):
        super(PiT_Small, self).__init__()
