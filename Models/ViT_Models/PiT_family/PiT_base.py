...
class PiT_Base(nn.Module):
    def __init__(self, image_size=224, patch_size=14, stride=7, base_dims=[64, 64, 64], depth=[3, 6, 4], heads=[4, 8, 16],
                 mlp_ratio=4, num_classes=3, in_chans=3,
                 attn_drop_rate=.0, drop_rate=.0, drop_path_rate=.0):
        super(PiT_Base, self).__init__()
