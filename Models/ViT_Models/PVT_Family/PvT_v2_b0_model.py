...
class PvT_v2_b0(nn.Module):
    def __init__(self, img_size=224, patch_size=4, in_chans=3, num_classes=3, embed_dims=[32, 64, 160, 256],
                 ...
                 depths=[2, 2, 2, 2], sr_ratios=[8, 4, 2, 1], num_stages=4, linear=False):
        super().__init__()
