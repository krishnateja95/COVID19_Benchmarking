...
class DeepViT_S(nn.Module):
    def __init__(self, img_size=224, patch_size=16, in_chans=3, num_classes=3, embed_dim=396, depth=[False] * 16,
                 ...
                 use_cnn_embed=True, apply_transform=[False] * 11 + [True] * 5, transform_scale=True, scale_adjustment=0.5):
        super().__init__()
